...
#### Option 3 (Pop_Front)
- Removes the integer in the front of the list.
...
#### Option 4 (Pop_Back)
- Removes the integer in the back of the list.
...
#### Option 5 (Insert)
- Insert an integer at a specified index.
...
#### Option 6 (Remove)
-Remove an integer at a specified index.
...
#### Option 7 (Find)
- Finds the index location of an integer within the list.
...
#### Option 11 (Pop)
- Pops an integer off the top of the stack.
...
#### Option 14 (Average)
- Finds the average of the stack elements.
